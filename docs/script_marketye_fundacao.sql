...
-- migrations 20260911220000..20260912030000, exceto a de mobiliário (a de
...
-- ---------------------------------------------------------------------
-- 7) SEGURANÇA: superfície de EXECUTE, colunas e políticas (correções D-05/D-15/D-16/D-17) + QA MKY-110..116
-- ---------------------------------------------------------------------
-- =====================================================================
...
WITH f AS MATERIALIZED (
  ...
  FROM unnest(ARRAY['001','002','003','004','005','006','007','008','009','010','011','012','013','014','015','110','111','112','113','114','115','116']) AS c(codigo)
), qr AS MATERIALIZED (
...
SELECT CASE WHEN f.buscar = 1 AND f.cadastro = 1 AND f.avaliar = 1 AND f.portal = 1 AND f.vitrine_publica = 1 AND f.contestacao = 1 AND f.antiga_com_pii = 0
             ...
             AND c.politica_antiga_removida AND c.pii_fechada AND c.casos_qa >= 18 AND qr.passaram = qr.total
